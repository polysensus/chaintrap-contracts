...
library LibGame {
    ...
    event SetMerkleRoot(uint256 indexed gid, bytes32 indexed label, bytes32 indexed root);
    ...
    function checkRoot(Game2 storage self, bytes32[] calldata proof, bytes32 label, bytes32 node) internal view returns (bool) {
    ...
    function verifyRoot(Game2 storage self, bytes32[] calldata proof, bytes32 label, bytes32 node) internal view {
