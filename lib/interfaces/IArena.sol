...
interface IArena {
    ...
    function joinGame(GameID gid, bytes calldata profile) external;

    function _joinGame(GameID gid, address p, bytes calldata profile) external;
    ...
    function placeFurniture(GameID gid, bytes32 placement, uint256 id) external;
